/*! vtex-ng-filter - v0.4.2 - 2017-03-27 */
(function() {
      ...
      function Filter(filter) {
        ...
        this.setDelivery = (function(_this) {
          return function(item) {
            return $location.search('f_shippingEstimate', item.url);
          };
        })(this);
        if (this.type === 'date') {
...
angular.module("vtexNgFilter").run(function($templateCache) {   'use strict';
  ...
  $templateCache.put('vtex-ng-filter-summary.html',
    "<div class=\"filters-summary\"><small ng-if=\"filters.length\" ng-repeat=\"filter in filters.getAppliedFilters()\"><span ng-repeat=\"item in filter.getSelectedItems()\"><span class=\"label label-info\"><span translate=\"\">{{ item.name }}</span>&nbsp; <a href=\"javascript:void(0);\" ng-click=\"filter.clearItem(item)\"><i class=\"icon-remove-sign\"></i></a></span>&nbsp;</span></small></div>"
  );
